  ...
  return (
    <StyledConfirmEmail>
      <Container>
        ...
        <Text>
          Hey, you asked to reset you password because you forgot it, <Break />
          We&apos;ve already sent out the password reset link, Please check your
          <Break />
          email for it so you can reset your password . Thanks!
        </Text>
